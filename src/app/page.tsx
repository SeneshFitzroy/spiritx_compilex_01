        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0 md:space-x-4">
            <div className="border border-white/20 rounded-xl p-6 md:w-1/3">
              ...
              <h3 className="font-medium mb-2 text-[#DEE2E6]">Sign Up</h3>
              <p className="text-gray-300">
            ...
            <div className="border border-white/20 rounded-xl p-6 md:w-1/3">
              ...
              <h3 className="font-medium mb- text-[#DEE2E6]">Log In</h3>
              <p className="text-gray-300">
            ...
            <div className="border border-white/20 rounded-xl p-6 md:w-1/3">
              ...
              <h3 className="font-medium mb-2 text-[#DEE2E6]">Personalized Access</h3>
              <p className="text-gray-300">
